...
<div class="wrapper ScrollStyle">
    ...
    <div class="content-wrapper">
                    ...
                    <table id="packet_list" class="table table-bordered table-striped"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="width:10px"><input name="select_all" value="1" id="example-select-all"
                                        type="checkbox" /></th>
                                <!-- <th></th> -->
        ...
        <div class="dataTables_info" id="packet_list_info" role="status" aria-live="polite">
            Showing <span id="startTO">1</span> to <span id="endTo">00</span> of <span id="total_count">00</span>
            entries</div>
