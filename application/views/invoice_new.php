                     ...
                     <div class="col-lg-12">
                        <div class="invoice-details mt25">
                           <div class="well">
                              ...
                              <table class="w-100">
                                 <tr>
                                    <td width="300px">From : <span class="invoice_cname"></span></td>
                                    <td>Mo:</td>
                                 </tr>
                                 <tr>
                                    <td >Date: <span class="invoice_date"></span></td>
                                    <td>Challan No: <span class="invoice_cno"></span></td>
                                    <td>Ref No:</td>
                                 </tr>
                              </table>
                           </div>
                           ...
                           <table class="table table-bordered" id = "invoice_table">
                              ...
                              <tfoot>
                                 <tr>
                                    ...
                                    <th class="text-center sub_total_pcs"></th>
                                    <th class="text-center sub_total_Weight"></th>
                                    <th class="text-center none_process_piece"></th>
                                    <th class="text-center none_process_caret"></th>
                                    <th class="text-center rate"></th>
                                    <th class="text-center" id="amount"></th>
                                 </tr>
                                 <tr>
                                    <th class="text-right">Total:</th>
                                    <th class="text-center total_pcs"></th>
                  ...
                  <div class="panel-body p30">
                     <div class="row" >
                        <div class="col-lg-6">
                           <div class="invoice-from">
                              ...
                              <div class="left-div side-logo">
                                 <ul class="list-unstyled text-left">
                                    <h1>achromic lab llp</h1>
                                    <li>32, Ground Floor,akshar dimoand market, mini bazar varachha road,surat, gujarat - 395004</li>
                                    <!-- <li></li> -->
                                    <li>Call: 99744 27300, 79841 02715</li>
                                    <li>Email: achromiclabllp1974@gmail.com</li>
                                    <li>GSTIN 24ABXFA4579N1ZI</li>
                        ...
                        <div class="col-lg-12">
                           ...
                           <div class="invoice-items">
                              <!-- <div class="table-responsive"> -->
                              <table class="table table-bordered" id = "invoice_table_2">
                                 <thead>
                                    <tr>
                                       <th class="per70 text-center">No.</th>
                                       <th class="per5 text-center">Pcs</th>
